...
contract INFLHUB is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    INFLHUBDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("InfluenceHub", "INFLHUB") {
        uint256 _BNBRewardsFee = 3;
        uint256 _buyBackFee = 6;
        ...
        _marketingWallet = 0x4C51C5E0D52668A1cB5758f2863C43B36Dd1d283;
        dividendTracker = new INFLHUBDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "INFLHUB: The dividend tracker already has that address"
        );

        INFLHUBDividendTracker newDividendTracker = INFLHUBDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "INFLHUB: The new dividend tracker must be owned by the INFLHUB token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "INFLHUB: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "INFLHUB: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "INFLHUB: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "INFLHUB: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
        ...
        onlyOwner
    {
        require(
            ...
            "INFLHUB: The liquidity wallet is already this address"
        );
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "INFLHUB: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "INFLHUB: Cannot update gasForProcessing to same value"
        );
...
contract INFLHUBDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "INFLHUB_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(
            false,
            "INFLHUB_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main INFLHUB contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "INFLHUB_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "INFLHUB_Dividend_Tracker: Cannot update claimWait to same value"
        );
